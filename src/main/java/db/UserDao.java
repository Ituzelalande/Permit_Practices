...
public class UserDao {
    ...
    public User createUser(String user_id,String name, String user_name,String email,String phone,String gender_id,String birthDate,String password ) throws SQLException, ClassNotFoundException {
        User user = null;
        Statement statement = DataBaseUtils.getConnection().createStatement();
        String query = "insert into `users`(`user_full_name`,`user_username`,`user_email`,`user_phone`,`user_gender_id`,`user_birth_date`,`user_password`) values('" + name + "','" + user_name + "','" + email + "','" + phone + "','" + gender_id + "','" + birthDate + "','" + password + "')";
        ...
        public User viewUser(String user_id){
            User user =null;
            Statement statement = DataBaseUtils.getConnection().createStatement();
